...
Public Class TinhTrangTonKho
    ...
    Private Sub ketnoi()
        ...
        End Try
    End Sub
    Private Sub TinhTrangTonKho_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ketnoi()
        If con.State = ConnectionState.Closed Then
            con.Open()
        End If
        Dim lenhsql = "select top 5 TenMH,TongTien,GiaBan, MIN(SoLuong) as [Số Lượng] from HoaDonBan GROUP BY TenMH,TongTien,GiaBan ORDER BY Min(SoLuong)"
